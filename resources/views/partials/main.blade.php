...
<div class="flex_cent">
    ...
    <div class="flex_cent" id="site_card">
        <!-- 1° ROW -->
        <div class="bordo w_90 p-5 flex_around h-100 flex-wrap">
            <!-- Cards - Falle poi dinamiche (OK TIENILE COSI) -->
            <div class="card mx-3 p-0" style="width: 13.5rem;">
                <!-- Immagine -->
    ...
    <div class="flex_cent" id="site_icon">
        <div class="row flex_around w_90 m-0 h-100 bordo">
            <!-- 1 Col (Sono dinamiche)-->
            <div class="col-2 mx-4 bg-danger h-100 bordo"></div>
            <!-- 2 Col -->
            <div class="col-2 mx-4 bg-danger h-100 bordo"></div>
            <!-- 3 Col -->
            <div class="col-2 mx-4 bg-danger h-100 bordo"></div>
